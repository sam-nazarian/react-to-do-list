export const VisibilityControl = ({ setShowCompleted, cleanTasks, isChecked }) => {
  ...
  return (
    <div className="d-flex justify-content-between bg-dark-green text-white text-center p-2 border-secondary">
      ...
      <button onClick={handleDelete} className="btn btn-warning btn-sm">
        Clear All Tasks
      </button>
    </div>
  );
